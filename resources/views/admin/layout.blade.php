                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                <div>
                                    <strong>
                                        <span class=" label label-danger">Andrew Smith</span>
                                    </strong>
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    <strong>
                                        <span class=" label label-info">Jonney Depp</span>
                                    </strong>
                                    <span class="pull-right text-muted">
                                        <em>Yesterday</em>
                                    </span>
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    <strong>
                                        <span class=" label label-success">Jonney Depp</span>
                                    </strong>
                                    <span class="pull-right text-muted">
                                        <em>Yesterday</em>
                                    </span>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="selected">
                        <a href="{{route('product')}}">
                            <i class="fa fa-dashboard fa-fw"></i>Sản phẩm
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                            ...
                            <li>
                                <a href="morris.html">Thêm, xóa, sửa sản phẩm</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{route('user')}}">
                            <i class="fa fa-flask fa-fw"></i>Nhân viên</a>
                    </li>
                    <li>
                        <a href="tables.html">
                            <i class="fa fa-table fa-fw"></i>Hãng sản xuất</a>
                    </li>
                    <li>
                        <a href="forms.html">
                            <i class="fa fa-edit fa-fw"></i>Hóa đơn</a>
                        {{-- </li>
                    <li>
                        <a href="#">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        ...
                        <b>&nbsp;2,000 </b>Support Tickets Pending to Answere. nbsp;
                    </div>
                </div>
                <!--end  Welcome -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="alert alert-danger text-center">
                        ...
                        <b>20 </b>Meetings Sheduled This Month
                ...
                <div class="col-lg-3">
                    <div class="alert alert-success text-center">
                        ...
                        <b>27 % </b>Profit Recorded in This Month
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="alert alert-info text-center">
                        <i class="fa fa-rss fa-3x"></i>&nbsp;
                        <b>1,900</b> New Subscribers This Year
                ...
                <div class="col-lg-3">
                    <div class="alert alert-warning text-center">
                        ...
                        <b>2,000 $ </b>Payment Dues For Rejected Items
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    ...
                    <!-- <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> <strong> <b>Thêm sản phẩm </b></strong>
