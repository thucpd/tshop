  ...
  <div class="logmod__wrapper">
    ...
    <div class="logmod__container">
      <ul class="logmod__tabs">
        <li data-tabtar="lgm-2"><a href="#">Đăng ký</a></li>
        <li data-tabtar="lgm-1"><a href="#">Đăng nhập</a></li>
      </ul>
      <div class="logmod__tab-wrapper">
          ...
          @endif
    <form method="POST" action"{{route('user_register')}}" class="simform">
        {{csrf_field()}}
          ...
          <form accept-charset="utf-8" action="#" class="simform">
            ...
            <div class="sminputs">
              ...
              <div class="input string optional">
                ...
                <input class="string optional" maxlength="255" name="confirm_password" placeholder="Nhập lại mật khẩu" type="password" size="50" autocomplete="off" />
              </div>             
            </div>
            <div class="sminputs">
            <div class="input full">
            ...
            <div class="simform__actions">
              ...
              <span class="simform__actions-snameetext">Điều khoản sử dụng <a class="special" href="#" target="_blank" role="link">  Xem tại đây</a></span>
            </div> 
            <div>
      ...
      <div class="logmod__tab lgm-1">
        <div class="logmod__heading">
          <span class="logmod__heading-subtitle">Điền tên đăng nhập và mật khẩu để<strong> đăng nhập</strong></span>
        </div> 
        <div class="logmod__form">
          <form accept-charset="utf-8" action="#" class="simform">
            <div class="sminputs">
              <div class="input full">
                <label class="string optional" for="user-name">Tên đăng nhập</label>
                <input class="string optional" maxlength="255" name="user-email" placeholder="Email" type="email" size="50" autocomplete="off" />
              </div>
            </div>
            <div class="sminputs">
              <div class="input full">
                <label class="string optional" for="user-pw">Mật khẩu</label>
                <input class="string optional" maxlength="255" name="user-pw" placeholder="Password" type="password" size="50" autocomplete="off"/>
            ...
            <div class="simform__actions">
              ...
              <span class="simform__actions-sidetext"><a class="special" role="link" href="#">Quên mật khẩu ?<br>Nhấn vào đây để lấy lại mật khẩu</a></span>
            </div> 
          </form>
        </div> 
        <div class="logmod__alter">
